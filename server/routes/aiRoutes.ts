 ...
 */
router.post("/classify", checkPermission("ai.use"), async (req: AuthenticatedRequest, res) => {
  try {
 ...
 */
router.post("/agent-orchestrate", checkPermission("ai.use"), async (req: AuthenticatedRequest, res) => {
  try {
 ...
 */
router.post("/risk-synthesis", checkPermission("ai.use"), async (req: AuthenticatedRequest, res) => {
  try {
 ...
 */
router.post("/extract-document", checkPermission("ai.use"), async (req: AuthenticatedRequest, res) => {
  try {
