...
-- ============================================
-- NAIS EDR BATCH INDEX
-- ============================================
-- The NAIS distributions are multi-gigabyte XML archives.  They are indexed
-- asynchronously; request-time registry lookups must never download or parse
-- an archive.
