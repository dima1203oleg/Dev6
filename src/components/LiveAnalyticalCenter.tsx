...
export default function LiveAnalyticalCenter({
  ...
  const [isMuted, setIsMuted] = useState(() => {
    if (typeof window !== "undefined") {
      if ((window as any).__isTtsEnabled === false) {
        return true;
      }
    ...
    return true; // Default muted to comply with browser autoplay
  });
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={() => {
              ...
              (window as any).__isTtsEnabled = !nextMuted;
              localStorage.setItem("predator-tts-enabled", String(!nextMuted));
              if (nextMuted) {
                try { window.speechSynthesis.cancel(); } catch (_) {}
              }
              window.dispatchEvent(new CustomEvent("predator-tts-toggle", { detail: { enabled: !nextMuted } }));
              if (!nextMuted) {
            ...
            className={`p-2 rounded-lg flex items-center gap-2 border transition-all cursor-pointer ${!isMuted ? "bg-blue-600/20 border-slate-800 text-blue-400" : "bg-black/40 backdrop-blur-md shadow-[0_4px_30px_rgba(30,58,138,0.1)] border-slate-800 text-slate-500"}`}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 items-stretch mt-12 w-full">
        ...
        >
          <div className="bg-slate-900 border border-slate-800 p-2 rounded-lg space-y-4 shadow-2xl shadow-black/40 backdrop-blur-sm">
            ...
            <div className="flex-1 p-2 sm:p-3 md:p-4 flex flex-col gap-3 sm:gap-4 bg-slate-950 h-full w-full">
              {[
                ...
                <button
                  ...
                  className="w-full text-left bg-black/40 backdrop-blur-md shadow-[0_4px_40px_rgba(30,58,138,0.15)] hover:bg-black/40 hover:shadow-2xl shadow-black/40 transition-all duration-300 border border-slate-800 text-slate-300 p-2.5 rounded-lg transition-all flex items-center justify-between cursor-pointer group"
                >
                  <span>{act.text}</span>
          ...
          <div className="bg-indigo-950/10 border border-indigo-900/20 p-2 rounded-lg shadow-inner text-left space-y-2">
        ...
        <div
          className="lg:col-span-6 bg-slate-900 border border-slate-800 rounded-lg p-2 flex flex-col justify-between relative overflow-hidden min-h-[380px] shadow-2xl"
        ...
        >
          ...
          <AnimatePresence>
            {suggestionState === "visible" && (
              <motion.div
                ...
                className="absolute top-2 left-4 right-4 z-40 bg-indigo-950 border border-slate-800 p-2.5 rounded-lg flex items-center justify-between shadow-2xl gap-2"
              >
                <div className="flex items-center gap-2">
                ...
                <div className="flex gap-1.5 shrink-0 text-xs font-mono font-black">
                  ...
                  <button
                    ...
                    className="bg-black/40 backdrop-blur-md shadow-[0_4px_30px_rgba(30,58,138,0.1)] hover:bg-slate-850 border border-slate-800 text-slate-300 px-3 py-1.5 rounded-lg transition-colors cursor-pointer"
                  >
                    Пізніше
                  </button>
                </div>
          ...
          <div className="flex justify-center gap-1 bg-slate-900/60 border border-slate-800 p-1 rounded-lg self-center z-30 font-mono text-xs font-bold">
            {[
          ...
          <div className="flex-1 flex items-center justify-center relative min-h-[300px]">
            ...
            {graphNodes.map((node) => {
                    ...
                    <AnimatePresence>
                      {lastSpokenText && (
                        <motion.div
                          ...
                          className="absolute bottom-full mb-4 left-1/2 -translate-x-1/2 bg-slate-900/90 border border-slate-800 text-xs font-mono text-indigo-300 px-3 py-1.5 rounded-lg whitespace-nowrap shadow-2xl max-w-xs text-center leading-snug"
                        >
              ...
              return (
                ...
                >
                  <div
                    className={`p-2 rounded-lg border flex items-center gap-2 max-w-[170px] bg-slate-950/90 backdrop-blur-md transition-all ${
                      node.risk === "HIGH"
          ...
          <div className="w-full w-full mx-auto relative z-30">
            <div className="bg-slate-950/95 border border-slate-800 rounded-lg flex items-center p-1.5 shadow-[0_15px_40px_rgba(0,0,0,0.6)]">
              ...
              <button
                ...
                className="bg-blue-600 hover:bg-blue-500 text-white font-mono font-bold text-xs uppercase px-2 py-1.5 rounded-lg transition-all flex items-center gap-1"
              >
            ...
            <AnimatePresence>
              {searchSuggestions.length > 0 && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: 5 }}
                  className="absolute left-0 right-0 mt-1.5 bg-slate-900 border border-slate-800 rounded-lg overflow-hidden shadow-2xl divide-y divide-slate-900/60 z-50 text-left"
                >
        ...
        >
          ...
          <div className="bg-slate-900 border border-slate-800 p-2 rounded-lg space-y-4 shadow-2xl shadow-black/40 backdrop-blur-sm text-left">
            <div className="flex items-center gap-2 border-b border-slate-800 pb-2">
          ...
          <div className="bg-slate-900/40 border border-slate-800 p-2 rounded-lg space-y-3 shadow-xl shadow-black/20 text-left">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-2 mt-6 items-start relative z-10 w-full text-left">
        ...
        <div className="xl:col-span-8 bg-slate-900 border border-slate-800 rounded-lg p-2 space-y-3 shadow-xl shadow-black/20">
        ...
        <div className="xl:col-span-4 bg-slate-900/40 border border-slate-800 rounded-lg p-2 space-y-4 shadow-2xl shadow-black/40">
          <div className="flex justify-between items-start">
            ...
            <div
              className={`px-2 py-1 rounded-lg border text-center ${activeEntity?.riskScore && activeEntity.riskScore >= 80 ? "border-slate-800 bg-rose-500/5 text-rose-500" : "border-slate-800 bg-blue-500/5 text-blue-400"}`}
            >
          ...
          <div className="grid grid-cols-2 gap-2 text-xs font-mono font-bold">
            <button
              ...
              className="bg-black/40 backdrop-blur-md shadow-[0_4px_40px_rgba(30,58,138,0.15)] hover:bg-black/40 hover:shadow-2xl shadow-black/40 transition-all duration-300 border border-slate-800 text-slate-300 py-2 rounded-lg flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
            >
            ...
            <button
              ...
              className="bg-black/40 backdrop-blur-md shadow-[0_4px_40px_rgba(30,58,138,0.15)] hover:bg-black/40 hover:shadow-2xl shadow-black/40 transition-all duration-300 border border-slate-800 text-slate-300 py-2.5 rounded-lg flex items-center justify-center gap-1.5 transition-colors cursor-pointer col-span-2"
            >
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-2 pt-1 font-sans">
              {[
                ...
                <div
                  key={idx}
                  className={`p-2 rounded-lg border bg-slate-900/50 space-y-1 relative ${evt.risk === "HIGH" ? "border-slate-800" : "border-slate-800"}`}
                >
      ...
      <AnimatePresence>
        {showPdfDrawer && (
          <motion.div
            ...
            className="fixed top-[68px] right-0 bottom-[36px] w-full w-full bg-black/40 backdrop-blur-md shadow-[0_4px_40px_rgba(30,58,138,0.15)] border-l border-slate-800 shadow-2xl p-2 overflow-y-auto z-45 flex flex-col justify-between text-left font-sans"
          >
            <div>
              ...
              <div className="border border-dashed border-slate-800 bg-rose-500/5 p-2 rounded-lg text-center space-y-1 mb-5">
              ...
              <div className="space-y-4 text-xs text-slate-300">
                <div>
                  ...
                  <div className="bg-slate-900/50 rounded-lg p-2 space-y-1.5 font-mono text-xs">
                    <div className="flex justify-between">
                      <span>Назва:</span>
                ...
                <div>
                  ...
                  <div className="bg-indigo-950/15 border border-indigo-900/40 p-2 rounded-lg leading-relaxed italic text-indigo-200">
            ...
            <div className="border-t border-slate-800 pt-3 mt-4 flex items-center gap-2">
              <button className="flex-1 bg-blue-600 hover:bg-blue-500 text-white font-mono font-bold text-xs uppercase py-2.5 rounded-lg transition-all flex items-center justify-center gap-2 cursor-pointer shadow-2xl shadow-black/40 shadow-blue-500/15">
                <Download className="w-4 h-4" />
                Завантажити PDF
              </button>
              <button
                onClick={() => setShowPdfDrawer(false)}
                className="bg-black/40 backdrop-blur-md shadow-[0_4px_30px_rgba(30,58,138,0.1)] hover:bg-slate-850 border border-slate-800 text-slate-300 py-2.5 px-3 rounded-lg text-xs font-mono font-bold cursor-pointer"
              >
                Закрити
              </button>
            </div>
        ...
        {showMapDrawer && (
          ...
          >
            <div>
              ...
              <div className="w-full h-[240px] bg-black/40 backdrop-blur-md shadow-[0_4px_30px_rgba(30,58,138,0.1)] border border-slate-800 rounded-lg relative overflow-hidden flex items-center justify-center mb-4">
                <svg
              ...
              <div className="space-y-4 text-xs text-slate-300">
                ...
                <div className="bg-slate-900/40 border border-slate-800 rounded-lg p-2.5 space-y-2 font-mono text-xs">
            ...
            <div className="border-t border-slate-800 pt-3 mt-4 flex items-center gap-2">
              <button
                onClick={() => setShowMapDrawer(false)}
                className="w-full bg-blue-600 hover:bg-blue-500 text-white font-mono font-bold text-xs uppercase py-2.5 rounded-lg transition-all cursor-pointer shadow-2xl shadow-black/40 shadow-blue-500/15"
              >
