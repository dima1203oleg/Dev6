                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    {connectedEntities.length === 0 ? (
                      <div className="text-xs text-slate-500 font-mono p-2 bg-slate-900/20 rounded-lg border border-slate-800/60">Не знайдено пов'язаних об'єктів у базі</div>
                    ) : (
                      connectedEntities.map((conn, idx) => (
                        <div key={idx} className="bg-slate-950/40 backdrop-blur-md shadow-[0_4px_40px_rgba(30,58,138,0.15)] border border-slate-800 p-2 rounded-lg flex items-center justify-between text-xs hover:border-slate-800 hover:shadow-[0_0_15px_rgba(59,130,246,0.15)] transition-all duration-300 transition-all cursor-default">
                          <div className="flex items-center gap-2">
