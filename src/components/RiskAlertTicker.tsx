...
export default function RiskAlertTicker({ entities, onSelectEntity, onSelectTab }: RiskAlertTickerProps) {
  ...
  return (
    <div className="bg-slate-900 border border-red-500/20 rounded-lg p-2 space-y-3 relative overflow-hidden" id="risk-alert-ticker-container">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-800 pb-2.5">
        ...
        <div className="flex items-center flex-wrap gap-2">
          ...
          <div className="flex items-center gap-0.5 bg-slate-950/80 p-0.5 rounded-lg border border-slate-800/60">
            <button
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className="p-1.5 bg-slate-950/80 border border-slate-800 rounded-lg text-slate-400 hover:text-slate-200 disabled:opacity-30 disabled:pointer-events-none cursor-pointer"
            >
      ...
      <div className="bg-black/30 rounded-lg p-2 border border-slate-800 min-h-[76px] flex items-center justify-between gap-2">
      ...
      <AnimatePresence>
        {showToast && (
          <motion.div
            ...
            className="absolute bottom-4 right-4 left-4 bg-rose-950/95 border border-red-500/30 rounded-lg p-2 shadow-2xl flex items-center gap-2 z-50 backdrop-blur-md"
          >
            ...
            <button
              ...
              className="shrink-0 bg-red-600 hover:bg-red-500 text-white font-bold text-xs uppercase px-2.5 py-1.5 rounded-lg transition-all cursor-pointer font-mono"
            >
              Переглянути
            </button>
          </motion.div>
