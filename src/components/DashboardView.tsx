...
const CustomTooltip = ({ active, payload, label }: any) => {
  if (active && payload && payload.length) {
    return (
      <div className="bg-slate-950/90 border border-slate-800 p-2 rounded-lg shadow-xl backdrop-blur-sm">
...
export default function DashboardView({
  ...
  return (
    <div className="flex-1 p-2 sm:p-3 md:p-4 flex flex-col gap-3 sm:gap-4 bg-slate-950 h-full w-full" id="dashboard-view-root">
      ...
      >
        {stats.map((stat, i) => (
          <motion.div
            key={i}
            whileHover={{ y: -2 }}
            className="bg-slate-900 border border-slate-800 p-4 rounded-lg flex flex-col gap-1 relative overflow-hidden group cursor-pointer"
          >
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-lg p-6 relative overflow-hidden flex flex-col">
        <div className="absolute top-0 right-0 p-2 opacity-10 pointer-events-none">
          <Bot className="w-24 h-24 text-blue-500" />
        </div>
        <div className="flex items-start gap-2 relative z-10">
          <div className="p-2 bg-blue-500/10 border border-slate-800 rounded-lg shrink-0">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-slate-300 leading-relaxed font-medium w-full">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
        ...
        <div className="xl:col-span-8 space-y-6">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-lg p-6 flex flex-col gap-4 shadow-none">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-2">
              <div className="md:col-span-8 h-[240px] bg-black/40 backdrop-blur-md shadow-[0_4px_40px_rgba(30,58,138,0.15)] border border-slate-800 rounded-lg relative overflow-hidden flex items-center justify-center">
                <GeospatialHeatmap
              ...
              <div className="md:col-span-4 bg-black/40 border border-slate-800 rounded-lg p-2.5 flex flex-col justify-between">
          ...
          <div
            className="bg-slate-900/40 border border-slate-800 rounded-lg shadow-[0_4px_40px_rgba(30,58,138,0.15)] backdrop-blur-md p-2 shadow-xl space-y-4 relative overflow-hidden backdrop-blur-sm"
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 relative z-10">
              {/* Heatmap main canvas */}
              <div className="lg:col-span-8 relative h-[300px] bg-slate-950/80 border border-slate-800/80 rounded-lg overflow-hidden p-2 flex flex-col justify-between">
                  ...
                  {filteredEntities.map((ent) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {isSelected && (
                          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-[240px] bg-slate-950/95 border border-slate-800 p-2 rounded-lg shadow-2xl z-30 pointer-events-none space-y-1 text-left backdrop-blur-md">
              ...
              <div className="lg:col-span-4 bg-black/40 border border-slate-800 rounded-lg p-2 flex flex-col justify-between space-y-4">
                <div className="space-y-3.5">
                  ...
                  {/* Settings toggle */}
                  <div className="bg-slate-950/80 rounded-lg border border-slate-800 p-2 space-y-2">
          ...
          <D3HistoricalRiskTrendsWidget
            ...
            onSelectTab={onSelectTab}
          />
          <div className="bg-slate-900/40 border border-slate-800 rounded-lg shadow-[0_4px_40px_rgba(30,58,138,0.15)] backdrop-blur-md p-2 shadow-xl space-y-4 relative overflow-hidden backdrop-blur-sm">
          ...
          <div
            className="bg-[#0b1329]/40 border border-slate-800 rounded-lg p-2 shadow-xl space-y-4 relative overflow-hidden backdrop-blur-sm"
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2 relative z-10">
              ...
              <div className="bg-slate-950/70 border border-slate-800 rounded-lg p-2.5 flex flex-col justify-between space-y-4 hover:border-slate-800 transition-all group">
                <div>
                ...
                <div>
                  ...
                  <button
                    ...
                    className={`w-full py-2 px-3 text-xs font-black uppercase rounded-lg tracking-wider font-mono cursor-pointer transition-all ${radarStatus === "SCANNING" ? "bg-black/40 backdrop-blur-md shadow-[0_4px_30px_rgba(30,58,138,0.1)] text-slate-500" : "bg-blue-600 hover:bg-blue-500 text-white shadow-xl shadow-black/20 shadow-blue-500/10"}`}
                  >
                    {radarStatus === "SCANNING"
                      ? "Сканування..."
                      : "Запустити Скринінг"}
              ...
              <div className="bg-slate-950/70 border border-slate-800 rounded-lg p-2.5 flex flex-col justify-between space-y-4 hover:border-slate-800 transition-all group">
                ...
                <div>
                  ...
                  <button
                    ...
                    className={`w-full py-2 px-3 text-xs font-black uppercase rounded-lg tracking-wider font-mono cursor-pointer transition-all ${syncStatus === "SYNCING" ? "bg-black/40 backdrop-blur-md shadow-[0_4px_30px_rgba(30,58,138,0.1)] text-slate-500" : "bg-blue-600 hover:bg-blue-500 text-white shadow-xl shadow-black/20 shadow-blue-500/10"}`}
                  >
              ...
              <div className="bg-slate-950/70 border border-slate-800 rounded-lg p-2.5 flex flex-col justify-between space-y-4 hover:border-slate-800 transition-all group">
                ...
                <div>
                  {screeningResult ? (
                    <div className="text-xs text-rose-400 font-mono bg-rose-950/20 border border-rose-900/30 rounded-lg p-2 leading-relaxed mb-2.5 max-h-[56px] overflow-y-auto">
                      {screeningResult}
                    </div>
                  ) : (
                    <div className="text-xs text-slate-500 font-mono mb-2.5 font-semibold">
                  ...
                  <button
                    ...
                    className="w-full py-2 px-3 text-xs font-black uppercase rounded-lg tracking-wider font-mono bg-blue-600 hover:bg-blue-500 text-white cursor-pointer transition-all shadow-xl shadow-black/20 shadow-blue-500/10"
                  >
                    Запустити AML ШІ
                  </button>
                </div>
          ...
          {/* Risk Dynamics Chart */}
          <div
            className="bg-slate-900/40 border border-slate-800 rounded-lg p-2 shadow-2xl shadow-black/40 relative overflow-hidden"
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-mono font-bold uppercase tracking-wider border transition-colors ${showForecast ? "bg-sky-500/20 text-sky-400 border-slate-800" : "bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-sky-400 border-slate-800"}`}
                >
                ...
                {zoomIndices && (
                  <button
                    onClick={zoomOut}
                    className="flex items-center gap-1.5 px-2.5 py-1.5 bg-blue-500/10 hover:bg-blue-500/20 text-blue-400 rounded-lg text-xs font-mono font-bold uppercase tracking-wider border border-slate-800 transition-colors"
                  >
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-2.5 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-blue-400 rounded-lg text-xs font-mono font-bold uppercase tracking-wider border border-slate-800 transition-colors"
          ...
          <div
            className="bg-indigo-950/10 border border-indigo-900/30 rounded-lg p-2 relative overflow-hidden"
        ...
        <div className="xl:col-span-4 space-y-6">
          ...
          <div className="bg-slate-900/40 border border-slate-800 rounded-lg p-2 shadow-2xl shadow-black/40 space-y-3.5">
            ...
            <div className="space-y-2.5">
              {recentSearches.map((search, i) => (
                ...
                >
                  <div className="flex items-center gap-2.5">
                    <div className="p-1.5 rounded-lg bg-black/40 backdrop-blur-md shadow-[0_4px_30px_rgba(30,58,138,0.1)] border border-slate-800 text-slate-300 group-hover:text-blue-400 transition-colors">
                      {search.type === "Company" ? (
                        <Briefcase className="w-3.5 h-3.5" />
                      ) : search.type === "Person" ? (
                        <User className="w-3.5 h-3.5" />
          ...
          <div className="bg-slate-900/40 border border-slate-800 rounded-lg p-2 shadow-2xl shadow-black/40 space-y-3.5">
            ...
            <div className="space-y-3">
              {criticalRisks.map((risk, idx) => (
                <div
                  key={idx}
                  className="bg-black/40 backdrop-blur-md shadow-[0_4px_40px_rgba(30,58,138,0.15)] p-2 rounded-lg border border-slate-800 space-y-1.5"
                >
