    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-2">
        ...
        <div className="lg:col-span-2 space-y-4" id="active-phase-details">
          <div className="bg-slate-900/40 border border-slate-800 rounded-lg p-2 space-y-5">
                ...
                <div className="space-y-2" id="milestones-checkboxes">
                  {(milestonesState[activePhase.id] || []).map((m, idx) => (
                    <button
                      ...
                      className="w-full text-left bg-slate-950/40 hover:bg-slate-950/40 backdrop-blur-md shadow-[0_4px_40px_rgba(30,58,138,0.15)] border border-slate-800/50 hover:border-slate-800 p-2.5 rounded-lg flex items-start gap-2.5 transition-all"
                    >
                      {m.done ? (
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="bg-slate-900/40 border border-slate-800 rounded-lg p-2 space-y-5" id="ai-gpu-cluster-planner">
            ...
            >
              ...
              {gpuCalculations.cost > 0 ? (
                ...
                <div className="bg-black/40 backdrop-blur-md border border-slate-800 p-2.5 rounded-lg text-center text-slate-500 text-xs">
