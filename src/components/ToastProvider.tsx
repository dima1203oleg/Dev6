        ...
        <AnimatePresence>
          {toasts.map(toast => (
            <motion.div
              ...
              className={`pointer-events-auto flex items-start gap-3 p-3 min-w-[280px] w-full rounded-xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.5)] border backdrop-blur-xl ${
