    ...
    chapters: [
      {
        ...
        description:
          "NEXUS Analytics розробляється як суверенна платформа стратегічної розвідки та аналізу зв'язків (Link Analysis) класу Enterprise, покликана забезпечувати повномасштабний OSINT, аналіз транзакцій, виявлення бенефіціарів та інтелектуальну дедуплікацію даних.",
        requirements: [
          "REQ-VIS-001: Забезпечення Link Analysis корпоративних зв'язків",
          "REQ-VIS-002: Підтримка локальної роботи (Air-gapped mode)",
        ],
      },
      {
        title: "1.2 Ролі користувачів та сценарії використання (Use Cases)",
        description:
          "Детальний розподіл за типами аналітиків: OSINT-розслідувач, аналітик AML/CFT, державний аудитор, Red Team офіцер кібербезпеки.",
        requirements: [
          "REQ-VIS-003: Модель доступу на основі атрибутів (ABAC)",
          "REQ-VIS-004: Логування дій користувача без можливості перезапису (Audit trail)",
        ],
      },
      {
        title: "1.3 Архітектурні принципи та обмеження",
        description:
          "Орієнтація на мікросервісну ізоляцію, ліцензійну чистоту (уникнення GPL-зараження пропрієтарного коду за допомогою API-ізоляції), та хмароорієнтованість (Kubernetes, GitOps).",
        technicalDetails:
          "Ізоляція GPL-компонентів, таких як BBOT чи деякі утиліти Neo4j, досягається через гнучку API-маршрутизацію.",
        codeSnippet: {
          lang: "json",
          code: `{
    ...
    chapters: [
      {
        ...
        description:
          "Опис взаємодії NEXUS із зовнішніми реєстрами, Telegram-ботами та клієнтськими веб-браузерами через API Gateway. Розподіл на UI клієнт та групу сервісів (Core API, OSINT Engine, Graph Database, Search Index).",
...
`,
      ...
      },
      {
        ...
        description:
          "Керування конфігурацією середовища за допомогою декларативних маніфестів у Git. Автоматична синхронізація через ArgoCD.",
        requirements: [
          "REQ-ARC-001: Автоматичний Canary деплой за допомогою Argo Rollouts",
          "REQ-ARC-002: Стовідсоткова інфраструктура як код (IaC)",
        ],
      },
    ],
  },
    ...
    chapters: [
      {
        ...
        description:
          "Сервіс автентифікації на базі Keycloak з підтримкою MFA, OAuth2 та OpenID Connect. Генерація JWT-токенів з кастомними claims.",
        requirements: [
          "REQ-SRV-001: Інтеграція з Active Directory / LDAP",
          "REQ-SRV-002: Період дії сесії JWT не більше 15 хвилин",
        ],
      },
      {
        title: "3.2 OSINT Worker Service & ETL Pipeline",
        description:
          "Воркери на Celery/FastAPI, що асинхронно збирають дані з реєстрів, проходять капчі за допомогою анти-капча проксі та відправляють сирі дані в S3 (MinIO).",
...
`,
      ...
      },
      {
        ...
        description:
          "Сервіс дедуплікації. Обчислює відстань Левенштейна та семантичну подібність (векторні ембедінги в Qdrant) для знаходження ідентичних осіб.",
        requirements: [
          "REQ-SRV-003: Точність розпізнавання дублікатів персон не менше 95%",
          "REQ-SRV-004: Створення зв'язку SAME_AS в графовій базі Neo4j",
        ],
      },
    ],
  },
    ...
    chapters: [
      {
        ...
        description:
          "Головне сховище транзакційних даних, метаданих користувачів, черг та звітів. Партиціонування за датою та типом подій.",
...
`,
      ...
      },
      {
        ...
        description:
          "База даних для швидкого семантичного пошуку по неструктурованих судових рішеннях та описах медіа-статей.",
        requirements: [
          "REQ-DAT-001: Зберігання 1536-вимірних векторів BGE-M3 / OpenAI",
          "REQ-DAT-002: Швидкість пошуку найближчих сусідів (k-NN) < 50мс",
        ],
      },
    ],
  },
    ...
    chapters: [
      {
        ...
        description:
          "Детальний опис API-конекторів до Clarity Project, Opendatabot, YouControl, а також парсингу офіційних JSON-дампів з Data.gov.ua.",
        requirements: [
          "REQ-OSN-001: Інтеграція судових рішень через Єдиний реєстр судових рішень",
          "REQ-OSN-002: Парсинг засновників з ЄДР у реальному часі",
        ],
      },
      {
        title: "5.2 Соціальні мережі та Telegram-моніторинг",
        description:
          "Скрейпінг публічних каналів, груп обговорень у Telegram, аналіз постів у Facebook/LinkedIn за ключовими словами.",
    ...
    chapters: [
      {
        ...
        description:
          "Кожен агент функціонує в ізольованому контексті з доступом до інструментів пошуку (Neo4j, PostgreSQL).",
...
`,
      ...
      },
      {
        ...
        description:
          "Використання протоколу MCP для стандартизації взаємодії між ШІ-моделями та інструментами бази даних у Air-gapped режимі.",
        requirements: [
          "REQ-AI-001: Локальне виконання моделей через vLLM (Llama-3-8B-Instruct)",
          "REQ-AI-002: Підтримка PagedAttention для оптимізації GPU пам'яті",
        ],
      },
    ],
  },
    ...
    chapters: [
      {
        ...
        description:
          "Максимально лаконічний інтерфейс у темно-сірому стилі (Slate/Zinc) з контрастними акцентами (Indigo/Emerald). Стовідсоткова адаптивність.",
        requirements: [
          "REQ-UI-001: Час відгуку інтерфейсу на перемикання вкладок < 100мс",
          "REQ-UI-002: Підтримка гарячих клавіш для швидкої навігації",
        ],
      },
      {
        title: "7.2 Графова панель аналізу зв'язків",
        description:
          "Візуалізація графових вершин та ребер з можливістю динамічного розгортання сусідніх зв'язків (Force-directed graph за допомогою d3.js).",
    ...
    chapters: [
      {
        ...
        description:
          "Комбінована оцінка ризику на основі сукупності факторів: зв'язки з РФ/РБ, відкриті судові справи, офшорні засновники, податковий борг.",
        requirements: [
          "REQ-ANL-001: Можливість кастомізації ваг ризиків у панелі адміністратора",
          "REQ-ANL-002: Розрахунок транзитивного ризику (якщо засновник має високий ризик, компанія успадковує коефіцієнт)",
        ],
      },
      {
        title: "8.2 Алгоритми пошуку закономірностей у графах",
        description:
          "Використання алгоритмів Louvain Modularity для кластеризації компаній у бізнес-групи та PageRank для знаходження ключових хабів впливу.",
    ...
    chapters: [
      {
        ...
        description:
          "Зберігання сертифікатів, API-ключів держреєстрів та токенів ШІ у динамічних секретах HashiCorp Vault з автоматичною ротацією.",
        requirements: [
          "REQ-SEC-001: Шифрування даних у спокої (AES-256-GCM)",
          "REQ-SEC-002: Повний mTLS між усіма подами кластера за допомогою Istio service mesh",
        ],
      },
      {
        title: "9.2 Модель доступу RBAC & ABAC та OPA",
        description:
          "Перевірка дозволів користувача за допомогою Open Policy Agent (OPA) на основі географічного положення, IP та рівня доступу.",
    ...
    chapters: [
      {
        ...
        description:
          "Скрипти для автоматичного створення VM у хмарі (AWS/GCP) або на локальних серверах (VMware, RKE2).",
        requirements: [
          "REQ-OPS-001: Створення Kubernetes кластера за 15 хвилин за допомогою IaC",
          "REQ-OPS-002: Створення локального S3 сховища через MinIO оператор",
        ],
      },
      {
        title: "10.2 Моніторинг, Метрики та Трейсинг (Prometheus, Grafana, Tempo)",
        description:
          "Збір метрик CPU, пам'яті, швидкості виконання запитів Neo4j/Qdrant, логування помилок воркерів у Loki.",
    ...
    chapters: [
      {
        ...
        description:
          "Повний опис кінцевих точок для отримання сутностей, створення аналітичних проектів та підписки на реальні оновлення подій.",
    ...
    chapters: [
      {
        ...
        description:
          "Правила написання чистого коду (Clean Code), використання ESLint, Prettier, Black (для Python), правила коммітів Conventional Commits.",
        requirements: [
          "REQ-DEV-001: Покриття юніт-тестами нового коду не менше 80%",
          "REQ-DEV-002: Обов'язкове проходження стадії статичного аналізу SonarQube у CI",
        ],
      },
    ],
  },
    ...
    chapters: [
      {
        ...
        description:
          "Резервне копіювання стану кластера K8s та сховищ баз даних за допомогою Velero у MinIO S3 кожну ніч.",
        requirements: [
          "REQ-OPS-003: Час відновлення системи (RTO) менше 1 години",
          "REQ-OPS-004: Максимальна втрата даних (RPO) не більше 4 годин",
        ],
      },
    ],
  },
    ...
    chapters: [
      {
        ...
        description:
          "Консоль керування клієнтськими організаціями (тенантність/Multi-tenancy), моніторинг спожитих токенів ШІ та API запитів.",
        requirements: [
          "REQ-ADM-001: Ізоляція даних організацій-клієнтів на рівні окремих баз (Database-per-tenant)",
          "REQ-ADM-002: Моніторинг активності воркерів у реальному часі",
        ],
      },
    ],
  },
    ...
    chapters: [
      {
        ...
        description:
          "Чіткі рамки та функціональні обмеження кожної редакції. Версія Military включає підтримку офлайн-карт, супутникових знімків та офлайн-ШІ моделей.",
        requirements: [
          "REQ-COM-001: Community версія постачається під ліцензією AGPL-3.0",
          "REQ-COM-002: Enterprise та Military постачаються під закритими комерційними ліцензіями",
        ],
      },
    ],
  },
...
export default function VolumesTab() {
  ...
  return (
    ...
    >
      {/* Intro Header banner */}
      <div className="bg-slate-900 border border-slate-800 rounded-lg p-2 backdrop-blur-md relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-2">
          <div>
            ...
            <p className="text-slate-300 text-xs leading-relaxed w-full">
              Повний еталонний пакет системної архітектури, розроблений для масштабування OSINT платформи. Містить 16
              взаємопов'язаних томів, детальні діаграми, схеми даних, інфраструктурний код та понад 450+ функціональних
              вимог для реалізації.
            </p>
          </div>

          <div className="flex items-center gap-2 text-xs font-mono bg-slate-950/40 backdrop-blur-md shadow-[0_4px_40px_rgba(30,58,138,0.15)] border border-slate-800 px-2 py-1.5 rounded-lg shrink-0">
            <div>
      ...
      <div className="bg-slate-900/30 border border-slate-800 rounded-lg p-2 flex flex-col md:flex-row items-center justify-between gap-2">
        ...
        <div className="flex flex-wrap gap-1.5 items-center w-full md:w-auto" id="volume-category-filters">
          ...
          {categories.map((cat) => (
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-bold uppercase tracking-wider transition-all cursor-pointer ${selectedCategory === cat ? "bg-blue-600 text-white" : "bg-slate-900/60 text-slate-300 hover:text-slate-200 hover:bg-slate-850"}`}
            >
        ...
        <div className="relative w-full md:w-80">
          <input
            ...
            className="w-full bg-slate-950/40 backdrop-blur-md shadow-[0_4px_40px_rgba(30,58,138,0.15)] border border-slate-800 rounded-lg pl-9 pr-4 py-2 text-xs text-slate-300 focus:outline-none focus:ring-1 focus:ring-blue-500 placeholder:text-slate-500"
          />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-2">
          ...
          {filteredVolumes.map((vol) => {
            ...
            return (
              <button
                ...
                className={`w-full text-left p-2.5 rounded-lg border transition-all text-xs flex items-start gap-2.5 relative cursor-pointer ${isActive ? "bg-blue-500/10 border-slate-800 text-white shadow-2xl shadow-black/40 shadow-blue-500/5" : "bg-slate-900/40 border-slate-800/80 text-slate-300 hover:text-slate-200 hover:border-slate-800"}`}
              >
                <div
                  className={`p-2 rounded-lg shrink-0 ${isActive ? "bg-blue-500/20 text-blue-400" : "bg-slate-950/40 backdrop-blur-md shadow-[0_4px_40px_rgba(30,58,138,0.15)] text-slate-500"}`}
                >
                ...
                <div className="flex-1 p-2 sm:p-3 md:p-4 flex flex-col gap-3 sm:gap-4 bg-slate-950 h-full w-full">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs text-blue-400 font-mono font-bold">{vol.chapters.length} розділів</span>
                  </div>
        ...
        <div
          className="lg:col-span-8 space-y-5 bg-slate-950/40 backdrop-blur-md shadow-[0_4px_40px_rgba(30,58,138,0.15)] border border-slate-800 rounded-lg p-2"
          id="volume-details-workspace"
        >
          ...
          <div className="space-y-4" id="chapters-accordion-group">
            ...
            {currentVolumeObj.chapters.map((ch, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className={`border rounded-lg transition-all ${isOpen ? "bg-slate-900/40 border-slate-800" : "bg-slate-900/10 border-slate-800 hover:border-slate-800"}`}
                >
                  {/* Title Toggle bar */}
                  <button
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-semibold text-xs text-slate-200 leading-snug">{ch.title}</span>
                    </div>
                    {isOpen ? (
                    ...
                    {isOpen && (
                      ...
                      >
                        <div className="px-3 pb-5 pt-1 border-t border-slate-800 space-y-4 text-xs">
                          ...
                          {ch.technicalDetails && (
                            <div className="bg-slate-950/60 border border-slate-800/40 rounded-lg p-2 space-y-1">
                              <span className="text-xs text-amber-400 font-mono uppercase tracking-widest block font-bold">
                                Архітектурні особливості:
                              </span>
                              <p className="text-slate-300 text-xs leading-relaxed">{ch.technicalDetails}</p>
                            </div>
                          )}
                          ...
                          {ch.codeSnippet && (
                            <div className="space-y-1.5">
                              ...
                              <div className="bg-slate-950/40 backdrop-blur-md shadow-[0_4px_40px_rgba(30,58,138,0.15)] rounded-lg p-2.5 border border-slate-800 overflow-x-auto">
                            ...
                            <div className="space-y-1.5">
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                                {ch.requirements.map((req, rIdx) => (
                                  <div
                                    key={rIdx}
                                    className="bg-slate-950/40 border border-slate-800 rounded-lg p-2.5 flex items-start gap-2 text-xs text-slate-300"
                                  >
          ...
          <div className="bg-slate-900/20 border border-slate-800 rounded-lg p-2 flex items-start gap-2 text-xs">
            ...
            <div className="space-y-1">
              ...
              <p className="text-slate-300 leading-normal">
                Кожен том містить точні, затверджені в ТЗ специфікації, які є обов'язковими для дотримання при побудові
                NEXUS OSINT. Натисніть на розділи вище для детального ознайомлення, копіювання коду та перевірки
                системних вимог (REQ).
              </p>
            </div>
          </div>
