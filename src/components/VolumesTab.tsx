...
export default function VolumesTab() {
  ...
  return (
    <div className="flex-1 p-2 sm:p-3 md:p-4 flex flex-col gap-3 sm:gap-4 bg-slate-950 h-full w-full" id="volumes-tab-root">
      {/* Intro Header banner */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-2">
        ...
        <div className="lg:col-span-4 space-y-2.5 overflow-y-auto max-h-[650px] pr-2" id="volumes-selectors-pane">
          {filteredVolumes.map((vol) => {
            ...
            return (
              ...
              >
                <div className={`p-2 rounded-lg shrink-0 ${isActive ? 'bg-blue-500/20 text-blue-400' : 'bg-slate-950/40 backdrop-blur-md shadow-[0_4px_40px_rgba(30,58,138,0.15)] text-slate-500'}`}>
        ...
        <div className="lg:col-span-8 space-y-5 bg-slate-950/40 backdrop-blur-md shadow-[0_4px_40px_rgba(30,58,138,0.15)] border border-slate-800 rounded-lg p-2" id="volume-details-workspace">
