...
import { OSINT_ENTITIES, OsintEntity } from "../types/osint";
...
function LocationMarker({
  ...
  return (
    <>
      ...
      >
        <Pin background={pinColor} borderColor="#020617" glyphColor="#ffffff" scale={isSelected ? 1.3 : 1.0} />
      </AdvancedMarker>
        ...
        <div className="flex items-center gap-2 bg-slate-950/80 p-1.5 rounded-2xl border border-slate-800">
          <button
            ...
            className={`px-3.5 py-1.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-1.5 cursor-pointer ${
              activeViewMode === "google" ? "bg-blue-600 text-white shadow-lg" : "text-slate-400 hover:text-slate-200"
            }`}
          >
          ...
          <button
            ...
            className={`px-3.5 py-1.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-1.5 cursor-pointer ${
              activeViewMode === "tactical" ? "bg-blue-600 text-white shadow-lg" : "text-slate-400 hover:text-slate-200"
            }`}
          >
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-slate-300 leading-relaxed max-w-2xl">
                  Для активації інтерактивних векторних карт, супутникових знімків High-Res та Google Places
                  Autocomplete додайте ключ у секрети AI Studio:
                </p>
                <ol className="text-xs text-slate-400 space-y-1 list-decimal list-inside font-mono pt-1">
                  ...
                  <li>
                    Відкрийте <strong>Settings (⚙️)</strong> у верхньому правому куті AI Studio →{" "}
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-2" id="maps-hud-stats">
        ...
        <div className="bg-[#0b1329]/60 border border-slate-800 rounded-2xl p-2 flex items-center justify-between shadow-2xl shadow-black/40">
          <div>
            ...
            <span className="text-lg font-black text-blue-400 tracking-tight mt-1 block">
              {activeLayersCount} / 4 шарів
            </span>
        ...
        <div className="xl:col-span-8 bg-slate-900/40 border border-slate-800 rounded-2xl p-3 shadow-2xl relative overflow-hidden backdrop-blur-sm">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 font-mono">
                  {activeViewMode === "google"
                    ? "Google Maps Platform — Супутникові дані & Векторний шар"
                    : "Тактичний векторний растр"}
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-1 bg-slate-950/80 p-1.5 rounded-2xl border border-slate-800/60">
              <button
                ...
                className={`px-3 py-1.5 rounded-2xl text-xs font-bold uppercase tracking-wider transition-all cursor-pointer ${
                  mapZoom === "ukraine" ? "bg-blue-600 text-white shadow" : "text-slate-300 hover:text-slate-200"
                }`}
              >
                Україна
              </button>
              <button
                ...
                className={`px-3 py-1.5 rounded-2xl text-xs font-bold uppercase tracking-wider transition-all cursor-pointer ${
                  mapZoom === "kyiv" ? "bg-blue-600 text-white shadow" : "text-slate-300 hover:text-slate-200"
                }`}
              >
                Київ
              </button>
              <button
                ...
                className={`px-3 py-1.5 rounded-2xl text-xs font-bold uppercase tracking-wider transition-all cursor-pointer ${
                  mapZoom === "lviv" ? "bg-blue-600 text-white shadow" : "text-slate-300 hover:text-slate-200"
                }`}
              >
                Львів
              </button>
              <button
                ...
                className={`px-3 py-1.5 rounded-2xl text-xs font-bold uppercase tracking-wider transition-all cursor-pointer ${
                  mapZoom === "global" ? "bg-blue-600 text-white shadow" : "text-slate-300 hover:text-slate-200"
                }`}
              >
                Одеса
              </button>
          ...
          <div className="relative h-[480px] bg-slate-950/60 border border-slate-800 rounded-2xl overflow-hidden mt-3 shadow-inner">
              ...
              <div className="w-full h-full flex flex-col items-center justify-center p-6 text-center bg-slate-950/90 space-y-4">
                ...
                <div className="max-w-md space-y-2">
                  ...
                  <p className="text-xs text-slate-400 leading-relaxed">
                    Додайте секрет <code className="text-amber-300">GOOGLE_MAPS_PLATFORM_KEY</code> для запуску
                    супутникових та інтерактивних карт Google.
                  </p>
                </div>
                <button
                  onClick={() => setActiveViewMode("tactical")}
              ...
              <div className="relative w-full h-full flex items-center justify-center">
                ...
                <div className="absolute bottom-4 right-4 text-slate-800/40 pointer-events-none select-none z-10 w-24 h-24">
                  <svg viewBox="0 0 100 100" className="w-full h-full">
                    ...
                    <text x="50" y="15" textAnchor="middle" fill="#6366f1" fontSize="10" fontWeight="bold">
                      N
                    </text>
                    <text x="50" y="93" textAnchor="middle" fill="#f43f5e" fontSize="10" fontWeight="bold">
                      S
                    </text>
                  </svg>
                </div>
                ...
                <svg
                  ...
                  viewBox={mapZoom === "kyiv" ? "200 65 110 80" : mapZoom === "lviv" ? "65 95 60 50" : "0 0 500 280"}
                  fill="none"
                >
                  <defs>
                  ...
                  {(mapZoom === "ukraine" || mapZoom === "global") && (
                    <g className="opacity-20" stroke="#334155" strokeWidth="0.5" strokeDasharray="3 3">
                      ...
                      <text x="105" y="15" fill="#475569" fontSize="6" fontFamily="monospace" stroke="none">
                        24°E
                      </text>

                      <line x1="200" y1="0" x2="200" y2="280" />
                      <text x="205" y="15" fill="#475569" fontSize="6" fontFamily="monospace" stroke="none">
                        30°E
                      </text>

                      <line x1="300" y1="0" x2="300" y2="280" />
                      <text x="305" y="15" fill="#475569" fontSize="6" fontFamily="monospace" stroke="none">
                        36°E
                      </text>

                      <line x1="400" y1="0" x2="400" y2="280" />
                      <text x="405" y="15" fill="#475569" fontSize="6" fontFamily="monospace" stroke="none">
                        42°E
                      </text>

                      <line x1="0" y1="80" x2="500" y2="80" />
                      <text x="5" y="75" fill="#475569" fontSize="6" fontFamily="monospace" stroke="none">
                        50°N
                      </text>

                      <line x1="0" y1="180" x2="500" y2="180" />
                      <text x="5" y="175" fill="#475569" fontSize="6" fontFamily="monospace" stroke="none">
                        46°N
                      </text>
                    </g>
                  )}
            ...
            <div className="absolute bottom-3 left-3 bg-slate-950/80 border border-slate-800 px-2.5 py-1.5 rounded-2xl text-[8.5px] font-mono text-slate-400 z-20 flex items-center gap-1.5 uppercase select-none backdrop-blur-md">
              ...
              <span>
                ФОКУС:{" "}
                {selectedLoc
                  ? `${selectedLoc.lat.toFixed(4)}° N, ${selectedLoc.lng.toFixed(4)}° E (${selectedLoc.city})`
                  : "30.5238° E, 50.4501° N"}
              </span>
            </div>
          </div>
          ...
          <div className="bg-slate-950/80 rounded-2xl border border-slate-800/80 p-2.5 mt-3 grid grid-cols-2 md:grid-cols-4 gap-2 z-10 relative">
            <div className="flex items-center justify-between">
              ...
              >
                <div
                  className={`bg-white w-4 h-4 rounded-full shadow transition-transform ${mapShowHeatmap ? "translate-x-4" : "translate-x-0"}`}
                />
              </button>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              >
                <div
                  className={`bg-white w-4 h-4 rounded-full shadow transition-transform ${mapShowRoutes ? "translate-x-4" : "translate-x-0"}`}
                />
              </button>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              >
                <div
                  className={`bg-white w-4 h-4 rounded-full shadow transition-transform ${mapShowFlows ? "translate-x-4" : "translate-x-0"}`}
                />
              </button>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              >
                <div
                  className={`bg-white w-4 h-4 rounded-full shadow transition-transform ${mapShowRadar ? "translate-x-4" : "translate-x-0"}`}
                />
              </button>
            </div>
          </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2 overflow-hidden">
                      <div
                        className={`p-1.5 rounded-lg bg-black/40 border border-slate-800 text-slate-300 ${isSelected ? "text-blue-400" : ""}`}
                      >
                        {loc.id === "comp-1" || loc.id === "comp-2" ? (
                    ...
                    <span
                      className={`text-[10px] font-mono font-bold px-1.5 py-0.5 rounded border shrink-0 ${riskColorText}`}
                    >
                      {loc.riskScore}%
                    </span>
                  </div>
                ...
                <p className="text-[10px] text-slate-400 font-mono uppercase tracking-widest mt-0.5">
                  {selectedEntity.type === "company"
                    ...
                    : selectedEntity.type === "person"
                      ? "Фізична особа"
                      : "Криптовалютна адреса"}{" "}
                  • Код {selectedEntity.code}
                </p>
              </div>
