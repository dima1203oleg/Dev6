...
const SUBJECTS = {
  corporate: {
    ...
    conclusion:
      'ТОВ "Альфа-Трейд" — компанія з вираженим компроматом, систематично задіяна в корупційних схемах, податкових порушеннях, шахрайстві та має прямі та непрямі зв’язки з санкційними структурами. Ризик співпраці — критичний.',
    riskBreakdown: [
    ...
    facts: {
      criminal:
        "Фігурує у кримінальному провадженні №32024000000004567 за ст. 190 КК України (шахрайство) на суму понад 47 млн грн.",
      corruption:
        "Учасник схем розпилу державних коштів через публічні закупівлі (розслідування «Схем» від 11.06.2026). Отримала тендерів на 312+ млн грн.",
      financial:
        "Систематичні податкові борги (14.7 млн грн), арешти рахунків та зв’язки з 11 компаніями з ознаками фіктивності.",
    ...
    timeline: [
      {
        id: 101,
        date: "15.02.2023",
        event: "Податковий борг 14,7 млн грн, арешт рахунків",
        category: "Фінансовий",
        confidence: "High",
        source: "ДПС України",
      ...
      },
      {
        id: 102,
        date: "08.09.2023",
        event: "Господарський спір на 87 млн грн (невиконання зобов’язань)",
        category: "Судовий",
        confidence: "High",
        source: "ЄРСР",
      ...
      },
      {
        id: 103,
        date: "12.05.2024",
        event: "Фігурант кримінального провадження №32024000000004567 (шахрайство)",
        category: "Кримінальне",
        confidence: "High",
        source: "ЄРСР / Нацполіція",
        url: "https://reyestr.court.gov.ua",
        nodeId: "case1",
      },
      {
        id: 104,
        date: "03.11.2024",
        event: "Бенефіціар пов’язаний з компанією під санкціями ЄС",
        category: "Санкційний",
        confidence: "High",
      ...
      },
      {
        id: 105,
        date: "19.04.2025",
        event: "Масова зміна директорів та засновників (схема «скидання»)",
      ...
      },
      {
        id: 106,
        date: "11.06.2026",
        event: "Розслідування «Схем» про участь у розпилі бюджетних коштів",
        category: "Корупційний",
        confidence: "High",
        source: "«Схеми» / Радіо Свобода",
        url: "https://radiosvoboda.org",
        nodeId: "media1",
      },
    ],
    nodes: [
  ...
  person: {
    ...
    conclusion:
      "Іванов І.І. — особа з високим рівнем компромату, фігурант кримінальних справ, учасник корупційних схем, має непрямі зв’язки з санкційними структурами та численні репутаційні удари.",
    riskBreakdown: [
    ...
    facts: {
      criminal:
        "Фігурант у кримінальному провадженні №32023000000001234 за ст. 190 КК України (шахрайство в особливо великих розмірах).",
      corruption:
        "Учасник схеми розпилу державних коштів через тендери. 7 пов’язаних компаній отримали тендерів на 312+ млн грн.",
      financial:
        "Історичний податковий борг, арешти особистих рахунків та зв’язки з 11 компаніями з ознаками фіктивності.",
    ...
    timeline: [
      {
        id: 201,
        date: "12.03.2022",
        event: "Арешт рахунків через податковий борг у 8,4 млн грн",
        category: "Фінансовий",
        confidence: "High",
        source: "ДПС / ДВС",
      ...
      },
      {
        id: 202,
        date: "05.11.2023",
        event: "Фігурант кримінального провадження №32023000000001234 (шахрайство)",
        category: "Кримінальне",
        confidence: "High",
        source: "ЄРСР",
        url: "https://reyestr.court.gov.ua",
      ...
      },
      {
        id: 203,
        date: "18.06.2024",
        event: "Розслідування «Схем» про розпил бюджетних коштів",
        category: "Корупційний",
        confidence: "High",
        source: "«Схеми» / УП",
      ...
      },
      {
        id: 204,
        date: "02.01.2025",
        event: "Пов’язані компанії внесено до санкційного списку ЄС & РНБО",
        category: "Санкційний",
        confidence: "High",
      ...
      },
      {
        id: 205,
        date: "15.04.2026",
        event: "Масова заміна директорів у 9 компаніях (класична схема «скидання»)",
        category: "Корпоративний",
        confidence: "High",
        source: "ЄДР",
        url: "https://usr.minjust.gov.ua",
      ...
      },
      {
        id: 206,
        date: "04.07.2026",
        event: "Виток облікових даних у Darknet (Stealer Log: 14 паролів та компромат)",
        category: "Darknet / Leaks",
        confidence: "Medium",
        source: "IntelX / HIBP",
        url: "https://intelx.io",
        nodeId: "leak1",
  ...
  kizyma: {
    ...
    facts: {
      ...
      corporate:
        "ЄДР: Діючий ФОП Кізима Дмитро Миколайович (100% чистий статус). Будь-яка інша участь є помилковим збігом за ПІБ та не має стосунку до особи.",
    },
    timeline: [
      {
        id: 301,
        date: "15.01.2024",
        event: "Витяг з ЄДРПОУ: Офіційна реєстрація ФОП Кізима Д.М. за ІПН 3111724753",
        category: "Корпоративний",
        confidence: "High",
        source: "ЄДР",
        url: "https://usr.minjust.gov.ua",
      ...
      },
      {
        id: 302,
        date: "20.03.2025",
        event: "ЄДРСР: Офіційна перевірка на наявність судових справ. Жодних записів не виявлено",
        category: "Судовий",
        confidence: "High",
        source: "ЄДРСР",
        url: "https://reyestr.court.gov.ua",
      ...
      },
      {
        id: 303,
        date: "10.05.2025",
        event: "Податковий кабінет ДПС: Боргів з податків або ЄСВ не виявлено, діючий платник 3-ї групи",
        category: "Фінансовий",
        confidence: "High",
        source: "ДПС",
        url: "https://tax.gov.ua",
      ...
      },
      {
        id: 304,
        date: "01.08.2026",
        event: "Комплексний верифікований звіт: 100% безпечний статус за всіма державними базами даних",
        category: "Реєстри",
        confidence: "High",
        source: "OSINT Core Engine",
        url: "#",
        nodeId: "target",
      },
    ],
...
const DATA_SOURCES_CATALOG = [
  // 1. Українські державні реєстри
  {
    ...
    category: "1. Укр Реєстри",
    type: "Bulk XML / API",
    desc: "Основний реєстр компаній, ФОП та бенефіціарів України",
    status: "Active",
    color: "emerald",
  },
  {
    ...
    category: "1. Укр Реєстри",
    type: "Real-time API",
    desc: "Суди, боржники, реєстраційні зміни, нерухомість, авто",
    status: "Active",
    color: "emerald",
  },
  {
    id: "youcontrol",
    name: "YouControl (Open Data)",
    category: "1. Укр Реєстри",
    type: "API / Freemium",
    desc: "Корпоративна аналітика, афіліації та групи ризику",
    status: "Active",
    color: "emerald",
  },
  {
    ...
    category: "1. Укр Реєстри",
    type: "API / Freemium",
    desc: "Автоматизоване скорингове профайлювання бізнесу",
    status: "Active",
    color: "emerald",
  },
  {
    id: "ersr",
    name: "Єдиний реєстр судових рішень (ЄРСР)",
    category: "1. Укр Реєстри",
    type: "Bulk JSON / API",
    desc: "Ухвали, вироки, засідання та кримінальні справи",
    status: "Active",
    color: "emerald",
  },
  {
    ...
    category: "1. Укр Реєстри",
    type: "API + Bulk",
    desc: "Виконавчі провадження, борги, арешти майна",
    status: "Active",
    color: "emerald",
  },
  {
    id: "prozorro",
    name: "ProZorro (Публічні закупівлі)",
    category: "1. Укр Реєстри",
    type: "Open API",
    desc: "Державні тендери, учасники, дискваліфікації",
    status: "Active",
    color: "emerald",
  },
  {
    id: "prozorro_sale",
    name: "Prozorro.Sale (Продаж майна)",
    category: "1. Укр Реєстри",
    type: "Open API",
    desc: "Аукціони комунального та державного майна",
    status: "Active",
    color: "emerald",
  },
  {
    ...
    category: "1. Укр Реєстри",
    type: "API",
    desc: "Державна система відновлення та об’єктів інфраструктури",
    status: "Active",
    color: "emerald",
  },
  {
    ...
    category: "1. Укр Реєстри",
    type: "Open API",
    desc: "Трансакції казначейства та публічні кошти",
    status: "Active",
    color: "emerald",
  },
  {
    id: "nazk_declarations",
    name: "НАЗК Декларації & PEP",
    category: "1. Укр Реєстри",
    type: "API / Bulk",
    desc: "Декларації публічних службовців України",
    status: "Active",
    color: "emerald",
  },
  {
    id: "diam_building",
    name: "ДІАМ (Містобудування)",
    category: "1. Укр Реєстри",
    type: "Bulk / API",
    desc: "Дозволи на будівництво, ліцензії та сертифікати",
    status: "Active",
    color: "emerald",
  },
  {
    id: "customs_brokers",
    name: "Реєстр митних брокерів",
    category: "1. Укр Реєстри",
    type: "Bulk CSV",
    desc: "Митні склади, ліцензії та брокерські компанії",
    status: "Active",
    color: "emerald",
  },
  {
    id: "dps_vat",
    name: "Реєстр платників ПДВ (ДПС)",
    category: "1. Укр Реєстри",
    type: "API / Bulk",
    desc: "Податкові статуси, неприбуткові організації",
    status: "Active",
    color: "emerald",
  },
  {
    ...
    category: "1. Укр Реєстри",
    type: "Bulk CSV",
    desc: "Реєстрації транспортних засобів та автопарків",
    status: "Active",
    color: "emerald",
  },
  {
    id: "dzk_drrp",
    name: "Кадастр & Реєстр майна (ДЗК/ДРРП)",
    category: "1. Укр Реєстри",
    type: "API Layer",
    desc: "Земельні ділянки та права на нерухоме майно",
    status: "Active",
    color: "emerald",
  },
  {
    id: "prof_registries",
    name: "Реєстри адвокатів / нотаріусів",
    category: "1. Укр Реєстри",
    type: "Web Scraper / API",
    desc: "ЄРАУ, нотаріуси, аудитори, судові експерти",
    status: "Active",
    color: "emerald",
  },
  {
    id: "bankrupts_reg",
    name: "Реєстр банкрутств",
    category: "1. Укр Реєстри",
    type: "Bulk / API",
    desc: "Справи про банкрутство підприємств та осіб",
    status: "Active",
    color: "emerald",
  },
  ...
  // 2. Світові корпоративні реєстри
  {
    id: "opencorporates",
    name: "OpenCorporates",
    category: "2. Світові Реєстри",
    type: "API / Freemium",
    desc: "Найбільша відкрита база компаній у світі (200M+)",
    status: "Active",
    color: "emerald",
  },
  {
    ...
    category: "2. Світові Реєстри",
    type: "REST API",
    desc: "Реєстр компаній та бенефіціарів Великої Британії",
    status: "Active",
    color: "emerald",
  },
  {
    ...
    category: "2. Світові Реєстри",
    type: "Open REST API",
    desc: "Звітності та публічні фінансові документи компаній США",
    status: "Active",
    color: "emerald",
  },
  {
    id: "bundesanzeiger",
    name: "Bundesanzeiger (Germany)",
    category: "2. Світові Реєстри",
    type: "Open Web / Scraper",
    desc: "Офіційний корпоративний реєстр Німеччини",
    status: "Active",
    color: "emerald",
  },
  {
    id: "sirene_france",
    name: "SIRENE Registry (France)",
    category: "2. Світові Реєстри",
    type: "Open Data API",
    desc: "Національний реєстр компаній Франції",
    status: "Active",
    color: "emerald",
  },
  {
    id: "krs_poland",
    name: "KRS Poland (Krajowy Rejestr)",
    category: "2. Світові Реєстри",
    type: "API / Open Data",
    desc: "Судовий та бізнес реєстр Польщі",
    status: "Active",
    color: "emerald",
  },
  {
    id: "baltics_registers",
    name: "Baltic Business Registers",
    category: "2. Світові Реєстри",
    type: "API / Bulk",
    desc: "Естонія (e-Business), Латвія (Uzņēmumu), Литва",
    status: "Active",
    color: "emerald",
  },
  ...
  // 3. Санкції та Compliance
  {
    ...
    category: "3. Санкції & PEP",
    type: "Self-hosted API",
    desc: "400+ санкційних списків, PEP, FATF, INTERPOL",
    status: "Live Sync",
    color: "rose",
  },
  {
    ...
    category: "3. Санкції & PEP",
    type: "Bulk XML/CSV",
    desc: "Спеціально позначені громадяни та блоковані особи",
    status: "Active",
    color: "emerald",
  },
  {
    ...
    category: "3. Санкції & PEP",
    type: "Bulk XML",
    desc: "Консолідований санкційний список Європейського Союзу",
    status: "Active",
    color: "emerald",
  },
  {
    id: "uk_sanctions",
    name: "UK Sanctions List (HMT)",
    category: "3. Санкції & PEP",
    type: "Bulk CSV",
    desc: "Санкційний список Великої Британії",
    status: "Active",
    color: "emerald",
  },
  {
    id: "un_sanctions",
    name: "ООН Sanctions Consolidated List",
    category: "3. Санкції & PEP",
    type: "Bulk XML",
    desc: "Офіційні рішення Ради Безпеки ООН",
    status: "Active",
    color: "emerald",
  },
  {
    id: "rnbo",
    name: "Українські санкції (РНБО)",
    category: "3. Санкції & PEP",
    type: "API via OpenSanctions",
    desc: "Укази Президента України та рішення РНБО",
    status: "Active",
    color: "emerald",
  },
  {
    ...
    category: "3. Санкції & PEP",
    type: "Open Data API",
    desc: "Чорні списки компаній, відсторонених Світовим банком",
    status: "Active",
    color: "emerald",
  },
  ...
  // 4. PEP
  {
    ...
    category: "4. PEP",
    type: "Bulk JSON",
    desc: "Глобальні списки політиків та членів парламентів",
    status: "Active",
    color: "emerald",
  },
  {
    id: "wikidata_pep",
    name: "Wikidata PEP SPARQL",
    category: "4. PEP",
    type: "SPARQL Endpoint",
    desc: "Граф знань публічних осіб та родинних зв’язків",
    status: "Active",
    color: "emerald",
  },
  ...
  {
    id: "courtlistener",
    name: "CourtListener (RECAP US)",
    category: "5. Суди & Права",
    type: "REST API",
    desc: "База судових рішень та проваджень США",
    status: "Active",
    color: "emerald",
  },
  {
    id: "interpol_red",
    name: "Interpol Red Notices / Wanted",
    category: "5. Суди & Права",
    type: "Open Web Scraper",
    desc: "Міжнародний розшук та застереження",
    status: "Active",
    color: "emerald",
  },
  {
    ...
    category: "5. Суди & Права",
    type: "API",
    desc: "Розшук найнебезпечніших злочинців ЄС",
    status: "Active",
    color: "emerald",
  },
  ...
  {
    id: "ted_europe",
    name: "TED Europe Procurement",
    category: "6. Закупівлі",
    type: "API / Open Data",
    desc: "Європейські публічні тендери та закупівлі",
    status: "Active",
    color: "emerald",
  },
  {
    id: "sam_gov",
    name: "SAM.gov Contracts (USA)",
    category: "6. Закупівлі",
    type: "REST API",
    desc: "Федеральні контракти та постачальники уряду США",
    status: "Active",
    color: "emerald",
  },
  ...
  // 7. Митниця та торгівля
  {
    id: "un_comtrade",
    name: "UN Comtrade",
    category: "7. Митниця & Торгівля",
    type: "API",
    desc: "Глобальна статистика міжнародної торгівлі",
    status: "Active",
    color: "emerald",
  },
  {
    id: "importyeti",
    name: "ImportYeti Trade Intelligence",
    category: "7. Митниця & Торгівля",
    type: "Web / API",
    desc: "Аналіз митних декларацій та ланцюгів постачання",
    status: "Active",
    color: "emerald",
  },
  ...
  {
    id: "marinetraffic",
    name: "MarineTraffic / Vessel Tracking",
    category: "8. Логістика & Транспорт",
    type: "AIS Stream API",
    desc: "Відстеження суден, портів та заходи у санкційні зони",
    status: "Active",
    color: "emerald",
  },
  {
    ...
    category: "8. Логістика & Транспорт",
    type: "REST / Stream",
    desc: "Глобальне відстеження бізнес-джетів та авіації",
    status: "Active",
    color: "emerald",
  },
  ...
  // 9. Банківські та фінансові
  {
    ...
    category: "9. Фінанси & LEI",
    type: "REST API / Bulk",
    desc: "Міжнародні ідентифікатори юридичних осіб (LEI)",
    status: "Active",
    color: "emerald",
  },
  {
    id: "openfigi",
    name: "OpenFIGI Securities",
    category: "9. Фінанси & LEI",
    type: "REST API",
    desc: "Глобальні ідентифікатори цінних паперів та активів",
    status: "Active",
    color: "emerald",
  },
  ...
  {
    id: "blockchair",
    name: "Blockchair Multi-Chain API",
    category: "10. Крипто & Blockchain",
    type: "REST API",
    desc: "Аналіз транзакцій Bitcoin, Ethereum, USDT, TRON",
    status: "Active",
    color: "emerald",
  },
  {
    id: "etherscan_api",
    name: "Etherscan / BscScan Explorer",
    category: "10. Крипто & Blockchain",
    type: "REST API",
    desc: "Аналіз смарт-контрактів та гаманців",
    status: "Active",
    color: "emerald",
  },
  ...
  // 11. Геодані
  {
    ...
    category: "11. Геодані & Супутники",
    type: "Open API",
    desc: "Глобальний геокодер та адреси об’єктів",
    status: "Active",
    color: "emerald",
  },
  {
    ...
    category: "11. Геодані & Супутники",
    type: "Satellite API",
    desc: "Супутникові знімки високої роздільної здатності",
    status: "Active",
    color: "emerald",
  },
  ...
  {
    id: "shodan_engine",
    name: "Shodan Security Engine",
    category: "13. Інтернет & Network OSINT",
    type: "REST API",
    desc: "Пошук відкритих серверів, портів та витоків БД",
    status: "Active",
    color: "emerald",
  },
  {
    ...
    category: "13. Інтернет & Network OSINT",
    type: "Open Query",
    desc: "Пошук прихованих поддоменів та SSL-сертифікатів",
    status: "Active",
    color: "emerald",
  },
  ...
  {
    id: "github_api",
    name: "GitHub Leaks & Repos API",
    category: "14. Git-екосистема",
    type: "REST / GraphQL",
    desc: "Пошук скомпрометованих токенів, коду та репозиторіїв",
    status: "Active",
    color: "emerald",
  },
  ...
  // 16. Соціальні мережі
  {
    ...
    name: "Telegram Open Channels API",
    category: "16. Соціальні мережі",
    type: "MTProto / Web",
    desc: "Моніторинг пропагандистських та тіньових каналів",
    status: "Active",
    color: "emerald",
  },
  ...
  {
    id: "gdelt",
    name: "GDELT Project (Global Monitoring)",
    category: "17. Adverse Media",
    type: "Real-time BigQuery",
    desc: "Моніторинг новин та подій 100+ мовами в реальному часі",
    status: "Streaming",
    color: "blue",
  },
  {
    id: "google_news",
    name: "Google News RSS / Custom Search",
    category: "17. Adverse Media",
    type: "REST API",
    desc: "Скандальні публікації, «чорний PR» та негативні згадки",
    status: "Active",
    color: "emerald",
  },
  {
    id: "common_crawl",
    name: "Common Crawl Archive",
    category: "17. Adverse Media",
    type: "Bulk S3",
    desc: "Петабайти веб-архівів для пошуку видалених матеріалів",
    status: "Active",
    color: "emerald",
  },
  ...
  // 18. Dark Web & Leaks
  {
    ...
    category: "18. Dark Web & Leaks",
    type: "API / Freemium",
    desc: "Пошук у Darknet, Pastebin, витоках даних та логах",
    status: "Connected",
    color: "rose",
  },
  {
    id: "ahmia",
    name: "Ahmia.fi (Tor Engine)",
    category: "18. Dark Web & Leaks",
    type: "Onion Search API",
    desc: "Індексатор легальних .onion сайтів",
    status: "Active",
    color: "emerald",
  },
  {
    id: "ddosecrets",
    name: "DDoSecrets Leaks",
    category: "18. Dark Web & Leaks",
    type: "Tor / Archive",
    desc: "Публічні архіви витоків та службових документів",
    status: "Active",
    color: "emerald",
  },
  {
    ...
    category: "18. Dark Web & Leaks",
    type: "Search Engine",
    desc: "Архів витоків дипломатичних та урядових даних",
    status: "Active",
    color: "emerald",
  },
  {
    ...
    category: "18. Dark Web & Leaks",
    type: "REST API",
    desc: "Перевірка скомпрометованих паролів та e-mail",
    status: "Active",
    color: "emerald",
  },
  {
    id: "breachsense",
    name: "BreachSense / Stealer Logs",
    category: "18. Dark Web & Leaks",
    type: "API Monitor",
    desc: "Моніторинг зливів шкідливого ПЗ (RedLine, Vidar)",
    status: "Active",
    color: "emerald",
  },
  ...
  // 19. OSINT Frameworks
  {
    id: "spiderfoot_engine",
    name: "SpiderFoot OSINT Framework",
    category: "19. OSINT Frameworks",
    type: "Python Engine",
    desc: "Автоматизоване збирання розвідувальних даних",
    status: "Active",
    color: "emerald",
  },
  {
    id: "maigret_sherlock",
    name: "Maigret / Sherlock OSINT",
    category: "19. OSINT Frameworks",
    type: "Web Scraper",
    desc: "Пошук акаунтів фігуранта у 2000+ соцмережах",
    status: "Active",
    color: "emerald",
  },
  ...
  {
    id: "graphrag_engine",
    name: "GraphRAG / Graphiti Knowledge Engine",
    category: "20. AI Knowledge Graphs",
    type: "Vector + Graph",
    desc: "Темпоральні графи знань та семантичний розшук",
    status: "Active",
    color: "emerald",
  },
  ...
  // 21. Threat Intelligence
  {
    ...
    category: "21. Threat Intel",
    type: "REST API",
    desc: "База вразливостей, експлоітів та кібератак",
    status: "Active",
    color: "emerald",
  },
];
...
export default function AdverseIntelligencePanel({ personName = 'ТОВ "Альфа-Трейд"' }: AdverseIntelligencePanelProps) {
  ...
  useEffect(() => {
    ...
    const simulation = d3
      .forceSimulation<EvidenceNode>(currentSubject.nodes)
      .force(
        "link",
        d3
          .forceLink<EvidenceNode, EvidenceLink>(currentSubject.links)
          .id((d) => d.id)
          .distance(130),
      )
    ...
    const nodeGroup = svg
      ...
      .enter()
      .append("g")
      .call(d3.drag<SVGGElement, EvidenceNode>().on("start", dragstarted).on("drag", dragged).on("end", dragended))
    ...
    nodeGroup
      ...
      .html((d: any) => {
        ...
        let iconSvg = "";
        if (d.type === "person")
          iconSvg = `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>`;
        else if (d.type === "company")
          iconSvg = `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2"><rect x="4" y="2" width="16" height="20" rx="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M12 6h.01"/><path d="M12 10h.01"/><path d="M12 14h.01"/><path d="M16 10h.01"/><path d="M16 14h.01"/><path d="M8 10h.01"/><path d="M8 14h.01"/></svg>`;
        else if (d.type === "case")
          iconSvg = `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>`;
        else if (d.type === "sanction")
          iconSvg = `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="m4.93 4.93 14.14 14.14"/></svg>`;
        else if (d.type === "leak")
          iconSvg = `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>`;
        else
          iconSvg = `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>`;
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2 border-b border-slate-800 pb-2 overflow-x-auto custom-scrollbar">
        ...
        >
          ...
          <span>
            Action Plan ({completedActions}/{totalActions})
          </span>
        </button>
      </div>
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1 bg-slate-950 border border-rose-900/60 rounded-2xl p-3 sm:p-4 flex flex-col justify-between relative overflow-hidden shadow-2xl">
              ...
              <div className="bg-rose-950/40 border border-rose-500/30 rounded-xl p-3.5 relative z-10">
                ...
                <p className="text-xs text-rose-200 leading-relaxed font-medium">{currentSubject.conclusion}</p>
              </div>
              ...
              <div>
                ...
                <div className="h-48 w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart
                      data={currentSubject.riskBreakdown}
                      layout="vertical"
          ...
          <div className="bg-slate-950/70 border border-slate-800/80 rounded-2xl p-3 sm:p-4 shadow-xl">
            <div className="flex items-center justify-between mb-5 border-b border-slate-800/80 pb-3">
              ...
              <span className="text-xs font-mono text-slate-500">Об’єкт: {currentSubject.name}</span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-slate-900/50 border border-slate-800/80 rounded-xl p-4 hover:border-rose-900/50 transition-colors">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="text-xs font-bold text-rose-400 uppercase tracking-wider">Кримінальний Компромат</h4>
                </div>
                <p className="text-xs text-slate-300 leading-relaxed">{currentSubject.facts.criminal}</p>
              ...
              <div className="bg-slate-900/50 border border-slate-800/80 rounded-xl p-4 hover:border-amber-900/50 transition-colors">
                ...
                <p className="text-xs text-slate-300 leading-relaxed">{currentSubject.facts.corruption}</p>
                <div className="mt-3 flex items-center gap-2 text-[10px] text-slate-500 font-mono">
              ...
              <div className="bg-slate-900/50 border border-slate-800/80 rounded-xl p-4 hover:border-rose-900/50 transition-colors">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="text-xs font-bold text-rose-400 uppercase tracking-wider">Фінансовий Компромат</h4>
                </div>
                <p className="text-xs text-slate-300 leading-relaxed">{currentSubject.facts.financial}</p>
                <div className="mt-3 flex items-center gap-2 text-[10px] text-slate-500 font-mono">
              ...
              <div className="bg-slate-900/50 border border-slate-800/80 rounded-xl p-4 hover:border-purple-900/50 transition-colors">
                ...
                <div className="mt-3 flex items-center gap-2 text-[10px] text-slate-500 font-mono">
                  <span className="bg-purple-500/10 text-purple-400 px-1.5 py-0.5 rounded font-bold">
                    ВІДКРИТІ САНКЦІЇ
                  </span>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-rose-300">
                    Не рекомендується будь-яка форма співпраці. Ризики репутаційних, фінансових та юридичних втрат
                    значно перевищують потенційну вигоду.
                  </p>
                </div>
              </div>
              <button
        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
            ...
            <div className="flex items-center gap-2 overflow-x-auto">
              {["all", "Фінансовий", "Судовий", "Кримінальне", "Санкційний", "Корупційний", "Корпоративний"].map(
                (cat) => (
                  <button
                    key={cat}
              ...
              <tbody className="divide-y divide-slate-800/60 text-xs">
                {filteredTimeline.map((item) => (
                  <tr key={item.id} className="hover:bg-slate-900/40 transition-colors group">
                    <td className="py-3.5 px-4 font-mono font-bold text-rose-400 whitespace-nowrap">{item.date}</td>
                    <td className="py-3.5 px-4 font-medium text-slate-200 w-full">{item.event}</td>
            ...
            <div className="flex-1 overflow-y-auto space-y-3 pr-1 custom-scrollbar">
              {currentSubject.timeline
                ...
                .map((item) => (
                  <div
                    key={item.id}
                    className="bg-slate-900/60 border border-slate-800 rounded-xl p-3.5 hover:border-slate-700 transition-all"
                  >
                    <div className="flex items-center justify-between mb-1.5">
                      <span className="text-[10px] font-mono font-bold text-rose-400 uppercase">{item.category}</span>
            ...
            {filteredSources.map((src) => (
              ...
              >
                <div>
                  ...
                  <p className="text-[11px] text-slate-400 leading-relaxed mb-3">{src.desc}</p>
                </div>
        ...
        >
          <div className="flex items-center justify-between border-b border-slate-800 pb-4">
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">Оперативний план дій для аналітика та служб безпеки</p>
            </div>
          ...
          <div className="space-y-3">
            {[
              {
                id: "act1",
                title: "1. Заборонити проведення нових платежів та підписання договорів",
                phase: "0-7 Днів",
                critical: true,
              },
              {
                id: "act2",
                title: "2. Перевірити актуальний стан судових справ у ЄРСР за номером провадження",
                phase: "0-7 Днів",
                critical: true,
              },
              {
                id: "act3",
                title: "3. Запустити розширений Darknet-моніторинг витоків (IntelX / HIBP)",
                phase: "7-30 Днів",
                critical: false,
              },
              {
                id: "act4",
                title: "4. Провести глибокий фінансовий аналіз пов’язаних осіб через Opendatabot API",
                phase: "7-30 Днів",
                critical: false,
              },
              {
                id: "act5",
                title: "5. Підготувати офіційний юридичний меморандум для керівництва",
                phase: "7-30 Днів",
                critical: false,
              },
              {
                id: "act6",
                title: "6. Внести об’єкт до внутрішнього автоматизованого стоп-листа (Blacklist)",
                phase: "Довгострокові",
                critical: true,
              },
            ].map((item) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span
                    className={`text-xs font-semibold ${checkedActions[item.id] ? "line-through text-slate-500" : ""}`}
                  >
                    {item.title}
                  </span>
                </div>
