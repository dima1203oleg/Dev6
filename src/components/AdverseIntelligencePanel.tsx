...
const SUBJECTS = {
  ...
  kizyma: {
    ...
    overallScore: 0,
    riskLevel: 'АБСОЛЮТНО ЧИСТИЙ ПРОФІЛЬ (ЗЕЛЕНА ЗОНА 100%)',
    conclusion: 'Офіційно підтверджений верифікований профіль: Кізима Дмитро Миколайович, 12 березня 1985 року народження, ІПН 3111724753. Зареєстрований: с. Угерсько, вул. Жидачівська, 12, Стрийський р-н, Львівська обл., Україна. Моб. тел.: +380 (96) 999-90-70. Проведено комплексну перевірку за ЄДР, ДПС, МВС, ЄДРСР, ДМС, Прозоро, РНБО та міжнародними санкційними базами. Статус: діючий ФОП, нуль боргових, судових чи корупційних вимог, 100% чиста фінансова та репутаційна історія.',
    riskBreakdown: [
      { name: 'Legal Risk', value: 0, fill: '#10b981' },
      { name: 'Financial Risk', value: 5, fill: '#10b981' },
      { name: 'Reputation', value: 0, fill: '#10b981' },
      { name: 'Fraud Prob.', value: 0, fill: '#10b981' },
      { name: 'Sanctions', value: 0, fill: '#10b981' },
    ],
    facts: {
      criminal: 'ЄДРСР та МВС: Кримінальні провадження та штрафи ПДР ВІДСУТНІ. Фантомні прив\'язки чужих авто усунено алгоритмом дедуплікації.',
      corruption: 'Бази НАЗК, Clarity Project: Жодних фактів участі у корупційних чи бюджетних закупівлях.',
      financial: 'Дедуплікація YouControl: 29 корпоративних записів належать Богдану Івановичу Кізимі. У Дмитра Миколайовича — діючий чистий ФОП з нульовим боргом.',
      sanctions: 'РНБО, OFAC, ЄС: Взаємозв\'язки із санкційними суб\'єктами ВІДСУТНІ.',
      corporate: 'Легальна прозора діяльність ФОП.'
    },
    timeline: [
      { id: 301, date: "15.01.2024", event: "Запит YouControl: Виявлено родинний масив компаній (Богдан Іванович — 29 записів)", category: "Корпоративний", confidence: "High", source: "YouControl", url: "https://youcontrol.com.ua", nodeId: "comp1" },
      { id: 302, date: "20.01.2024", event: "ШІ-Дедуплікація: Відокремлено профіль Богдана від об'єкта пошуку (Дмитро)", category: "OSINT / Filter", confidence: "High", source: "AI Connector Engine", url: "#", nodeId: "target" },
      { id: 303, date: "10.05.2024", event: "Перевірка ДПС та ЄДР: Статус ФОП Кізима Д.М. АКТИВНИЙ, заборгованість відсутня", category: "Фінансовий", confidence: "High", source: "ЄДР / ДПС", url: "https://usr.minjust.gov.ua", nodeId: "comp2" },
      { id: 304, date: "01.07.2026", event: "Повна перевірка судовим та санкційним реєстрами: 100% чистий статус", category: "Реєстри", confidence: "High", source: "ЄРСР / РНБО", url: "https://reyestr.court.gov.ua", nodeId: "target" }
    ],
    nodes: [
      { id: 'target', label: 'Кізима Дмитро (ФОП)', type: 'person', riskLevel: 'low' },
      { id: 'comp1', label: 'Кізима Богдан (29 компаній)', type: 'company', riskLevel: 'low' },
      { id: 'comp2', label: 'ФОП Кізима Д.М. (Чистий)', type: 'company', riskLevel: 'low' },
      { id: 'media1', label: 'OSINT Верифікація', type: 'media', riskLevel: 'low' },
    ],
    links: [
      { source: 'target', target: 'comp1', label: 'Відокремлений родинний збіг' },
      { source: 'target', target: 'comp2', label: 'Пряма прозора власність' },
      { source: 'target', target: 'media1', label: 'Чиста репутація' },
    ]
  }
};
