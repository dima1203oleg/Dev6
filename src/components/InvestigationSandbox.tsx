...
export default function InvestigationSandbox() {
  ...
  return (
    <div className="flex-1 p-2 sm:p-3 md:p-4 flex flex-col gap-3 sm:gap-4 bg-slate-950 h-full w-full" id="investigation-sandbox-panel">
      
      {/* 1. TOP HEADER & METRIC CARDS */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 bg-slate-900/40 backdrop-blur-md shadow-[0_4px_30px_rgba(30,58,138,0.1)] border border-slate-800 p-2 rounded-lg">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-1 w-full leading-relaxed">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button 
            ...
            className="px-3.5 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-lg text-xs font-bold font-mono tracking-wider flex items-center gap-1.5 cursor-pointer shadow transition-all"
          >
          ...
          <button 
            ...
            className="px-3.5 py-2 bg-slate-800/80 hover:bg-slate-700 text-slate-200 border border-slate-800 rounded-lg text-xs font-bold font-mono tracking-wider flex items-center gap-1.5 cursor-pointer transition-all"
          >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-2 items-start">
        ...
        <div className="xl:col-span-3 bg-slate-950/80 backdrop-blur-xl border border-slate-800 rounded-lg overflow-hidden relative shadow-inner flex flex-col h-[600px] select-none">
          
          {/* Canvas Floating Utilities Panel */}
          <div className="absolute top-2 left-4 z-20 bg-slate-950/80 backdrop-blur-md shadow-[0_4px_30px_rgba(30,58,138,0.1)] border border-slate-800 p-2.5 rounded-lg flex items-center gap-2">
            <button 
            ...
            <button 
              ...
              className="p-1.5 bg-slate-900/50 hover:bg-slate-800 text-slate-300 hover:text-white rounded-lg cursor-pointer transition-colors flex items-center gap-1 text-xs font-mono font-bold"
            ...
            >
              {nodes.map((node) => {
                ...
                return (
                  ...
                  >
                    <motion.div 
                      className={`p-2 rounded-lg border flex flex-col bg-slate-950/95 shadow-2xl shadow-black/40 relative select-none ${isSelected ? 'border-blue-500 shadow-[0_0_15px_rgba(59,130,246,0.3)] ring-1 ring-blue-500' : 'border-slate-800/60 hover:border-slate-800'}`}
                    >
                      {/* Outer cascading risk border rings */}
                      {node.cascadedRisk > node.baseRisk && (
                        <div className="absolute -inset-1 border border-dashed border-slate-800 rounded-lg animate-ping opacity-60 pointer-events-none" />
                      )}
        ...
        <div className="bg-slate-900/40 backdrop-blur-md border border-slate-800 p-2 rounded-lg flex flex-col space-y-4 h-[600px] overflow-y-auto">
          ...
          {selectedNode ? (
            <div className="flex-1 p-2 sm:p-3 md:p-4 flex flex-col gap-3 sm:gap-4 bg-slate-950 h-full w-full">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 bg-slate-950/60 p-2 rounded-lg border border-slate-800/60">
                ...
                <div className="pt-2">
                  <button 
                    ...
                    className="w-full py-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white rounded-lg text-xs font-black font-mono tracking-wider uppercase flex items-center justify-center gap-1.5 cursor-pointer shadow-2xl shadow-black/40"
                  >
              ...
              <button 
                ...
                className="w-full py-2 bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 border border-slate-800 rounded-lg text-xs font-black font-mono tracking-wider uppercase flex items-center justify-center gap-1.5 cursor-pointer transition-colors"
              >
            ...
            <div className="space-y-4 flex-1 flex flex-col justify-between">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-slate-950/40 border border-slate-800 p-2.5 rounded-lg text-xs font-mono space-y-1">
        ...
        {showAddNodeModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-2">
            ...
            <motion.div 
              ...
              className="bg-slate-900/40 backdrop-blur-md border border-slate-800 p-2 rounded-lg w-full w-full relative z-10 shadow-2xl"
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-end gap-2 pt-2">
                  <button 
                    onClick={() => setShowAddNodeModal(false)} 
                    className="px-2 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-lg text-xs font-bold font-mono uppercase cursor-pointer"
                  >
                    Скасувати
                  </button>
                  <button 
                    onClick={handleAddNode}
                    className="px-2 py-1.5 bg-blue-600 hover:bg-blue-500 text-white rounded-lg text-xs font-bold font-mono uppercase cursor-pointer"
                  >
                    Створити
                  </button>
                </div>
