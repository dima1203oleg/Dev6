...
export default function GapAnalysisTab() {
  ...
  return (
    <div className="flex-1 p-2 sm:p-3 md:p-4 flex flex-col gap-3 sm:gap-4 bg-slate-950 h-full w-full" id="gap-analysis-tab-root">
      {/* Intro section */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-2">
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-slate-900/40 border border-slate-800 rounded-lg p-2 space-y-5" id="dynamic-estimator">
            ...
            <div className="bg-black/40 backdrop-blur-md shadow-[0_4px_40px_rgba(30,58,138,0.15)] rounded-lg p-2 border border-slate-800 space-y-3" id="estimator-results">
