...
export const ROADMAP_PHASES = [
  {
    ...
    focus: 'Підключення живих коннекторів YouScore та Opendatabot, створення єдиної схеми даних та нормалізація ідентифікаторів (РНОКПП, ЄДРПОУ).',
  ...
  },
  {
    ...
    focus: 'Побудова повноцінного графу зв’язків між контрагентами, запобігання помилковому об’єднанню гомонімів за ПІБ, виявлення непрямих зв’язків.',
  ...
  },
  {
    ...
    focus: 'Впровадження Gemini API та локальних LLM для автоматичного виявлення аномалій, ризиків та генерації комплаєнс-висновків без галюцинацій.',
    ...
    risks: ['Ризик некоректної інтерпретації юр. термінів ШІ-моделлю', 'Високі затримки при обробці великих векторних індексів'],
  ...
  },
  {
    ...
    focus: 'Підписка на зміни в реєстрах щодо відстежуваних суб’єктів, Push/Webhook сповіщення про нові судові справи, боги або зміну власників.',
  ...
  },
  {
    ...
    timeframe: 'Місяць 12',
    focus: 'Аналіз мультимедіа та OSINT матеріалів, розгортання високодоступного кластера та проходження безпекового аудиту.',
