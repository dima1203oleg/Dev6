...
export const FIVE_QUESTIONS_FRAMEWORK: FiveQuestionsItem[] = [
  ...
  },
  {
    ...
    verificationMethod: "Confidence Engine (0-100%) на основі перехресної перевірки джерел та відсутності суперечностей"
  },
  {
    number: 5,
    question: "ЧОМУ?",
    meaning: "Які докази та який алгоритм привели до цього висновку?",
    verificationMethod: "Explainable Risk/Graph Engine, Reasoning Traces, посилання на докази та відсутність галюцинацій"
  }
];
...
export const DEV5_145_SPEC_ITEMS: Dev5SpecItem[] = [
  ...
  },
  {
    ...
    title: "Видалення генерації залишків Math.random() та фиктивних станів",
    summary: "Очищення коду від залишків рандомізації та неузгоджених станів health-check.",
    requirements: [
      "Усунення будь-якої fallback/dynamic generation логіки з використання Math.random() у production paths.",
  ...
  },
  {
    ...
    summary: "DEV5 = Experience + Engine + Connectors + Evidence + Graph + Risk + AI + Security + Audit + Observability.",
    requirements: [
      "Повна інтеграція 10 ключових підсистем.",
      "Побудова єдиного стандарту передачі даних між шарами."
    ],
    status: "ACTIVE"
  },
  {
  ...
  },
  {
    ...
    summary: "Заборонено використання Math.random(), fake latency, fake metrics, fake risk, fake online status.",
    requirements: [
  ...
  },
  {
    ...
    requirements: [
      "LIVE, CACHED, STALE, OFFLINE, BROKEN, AUTH_FAILED, RATE_LIMITED, SCHEMA_DRIFT, UNKNOWN."
    ],
    status: "ACTIVE"
  },
  {
